...
export const eventsApi = {
  ...
  createEvent: (data: Partial<EventApiDto>) =>
    fetchJson<EventApiDto>("/api/events", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  updateEvent: (id: number, data: Partial<EventApiDto>) =>
    fetchJson<EventApiDto>(`/api/events/${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  deleteEvent: (id: number) =>
    fetchJson<void>(`/api/events/${id}`, {
      method: "DELETE",
    }),
  publishEvent: (id: number) =>
    fetchJson<EventApiDto>(`/api/events/${id}/publish`, {
      method: "PUT",
    }),
  unpublishEvent: (id: number) =>
    fetchJson<EventApiDto>(`/api/events/${id}/unpublish`, {
      method: "PUT",
    }),
};
