...
import { KnowledgeNetworkLayer } from "./layers/KnowledgeNetworkLayer";
...
export class UniverseRenderer {
  ...
  private readonly knowledgeNetworkLayer: KnowledgeNetworkLayer;
  ...
  constructor(options: RendererOptions) {
    ...
    try {
      ...
      logWarning("Universe background disabled: WebGLRenderer creation failed.", error);
    ...
    this.knowledgeNetworkLayer = new KnowledgeNetworkLayer(this.config, this.lowPower, this.disposables);
    this.root.add(this.knowledgeNetworkLayer.group);
  ...
  private stopAfterFailure(error: unknown) {
    ...
    this.animationId = null;
    this.visible = false;
    logWarning("Universe background disabled: WebGL rendering failed.", error);
  ...
  private render() {
    ...
    this.knowledgeNetworkLayer.update(t, pointerEnergy, this.pointer.x, this.pointer.y);
