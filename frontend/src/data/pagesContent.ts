...
export const pagesContentMap: Record<string, PageContent> = {
  ...
  "about/why-we-created-this-network": {
    ...
    eyebrow: "Pillars",
    description:
      "An inquiry into institutional silos, open knowledge systems, and collaborative futures.",
    layout: "editorial",
    parentLabel: "About",
    parentHref: "/about",
    editorialSections: [
      {
        ...
        content:
          "Traditional academic structures often restrict critical discourse to paywalled journals and exclusive conferences. We created the Posthuman Lab Network to build horizontal pathways connecting independent thinkers, artists, developers, and established scholars without institutional gatekeeping.",
      },
      {
        heading: "Knowledge as an Ecosystem",
        content:
          "We believe knowledge is not a static human product, but a dynamic ecosystem. Our programs are designed to treat technical code, philosophy, and environmental sensing as interconnected expressions of a shared planetary intelligence.",
      },
    ],
    relatedLinks: [
  ...
  "about/digital-to-real-practice": {
    ...
    eyebrow: "Methodology",
    description:
      "Translating speculative critical theory into tactile, local, real-world community actions.",
    layout: "editorial",
    parentLabel: "About",
    parentHref: "/about",
    editorialSections: [
      {
        ...
        content:
          "Philosophy should not exist solely as screen text. Our methodology bridges technical development (Next.js, Spring Boot, micro-electronics) with physical soil interactions, clay sculpting, and off-grid retreats. We test theories of posthuman agency by engaging with nonhuman actors directly.",
      },
      {
        heading: "Decentralized Action Cells",
        content:
          "Our members form localized cells to run ecological sensors, set up community forums, and host translation circles. These physical gatherings ensure that our planetary networking remains grounded in real-world practices.",
      },
    ],
    relatedLinks: [
  ...
  "about/future-vision": {
    ...
    eyebrow: "Horizon",
    description:
      "Strategic trajectories for interdisciplinary collaboration and technical expansion over the next decade.",
    layout: "editorial",
    parentLabel: "About",
    parentHref: "/about",
    editorialSections: [
      {
        ...
        content:
          "Our primary technical milestone is establishing a global, low-power sensing network. By deploying micro-controllers in collaboration with forest cells, we aim to map ecological telemetry data directly into a decentralized open archive.",
      },
      {
        heading: "CC Academy & Open Press",
        content:
          "We are expanding our open-press publications to provide peer-reviewed, free-access publishing tracks for emerging scholars and experimental media practitioners who challenge anthropocentric paradigms.",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "Auditing transformer neural weights and language assumptions from decolonial perspectives.",
        tag: "Active Project",
      },
      {
        title: "Symbiotic Systems Ethics",
        description:
          "Developing ethical frameworks that encompass nonhuman, botanical, and algorithm agents.",
        tag: "Working Group",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "Mapping slow growth patterns of biological lichen into dynamic canvas graphics.",
        tag: "Art Installation",
      },
      {
        title: "Acoustic Forest Ecology",
        description:
          "Recording sub-audible woodland electrical currents and converting them to modular synthesizers.",
        tag: "Audio Project",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "A secure, peer-to-peer bibliography indexing database managed by regional study cells.",
        tag: "Software Library",
      },
      {
        title: "Citizen-Science Bio-Audits",
        description:
          "Creating open instructions for mapping local plant species and environmental soil health.",
        tag: "Community Tool",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "Deploying low-cost turbidity sensors in urban streams to document pollution timelines.",
        tag: "Grassroots Project",
      },
      {
        title: "Open Digital Commons Mapping",
        description:
          "Documenting free local spaces, tool lending libraries, and community gardens.",
    ...
    items: [
      {
        ...
        description:
          "A virtual workshop mapping global temperature vectors into modular sound patterns.",
        tag: "Seasonal Focus",
      },
      {
        title: "Decolonial Software Patterns",
        description:
          "Collaborative translation of interface guidelines into multiple regional languages.",
    ...
    items: [
      {
        ...
        description:
          "Using standard Web Audio APIs to represent botanical voltages inside Next.js components.",
        tag: "Active Project",
      },
      {
        title: "Speculative Visual Essays",
        description:
          "Constructing multi-linear reading platforms using custom Framer Motion timelines.",
        tag: "Journal Project",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "A 4-week bibliography trace covering primary shifts in cognitive anthropocentrism.",
        tag: "Curriculum Map",
      },
      {
        title: "Track 2: Introduction to Sympoiesis",
        description:
          "Readings and podcasts introducing collective biological systems and Haraway's theories.",
        tag: "Curriculum Map",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "Discussion outlines, writing prompts, and exercise descriptions for local study cells.",
        tag: "Syllabus Handout",
      },
      {
        title: "Decolonial Computing Framework Guide",
        description:
          "Core questions for auditing digital software platforms and cloud architecture assumptions.",
        tag: "Handout Guide",
      },
    ],
    relatedLinks: [
  ...
  "learning/downloads": {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Code blocks and configuration templates matching our digital-organic UI system.",
        tag: "ZIP / Code Assets",
      },
    ],
    relatedLinks: [
  ...
  "learning/open-archive": {
    ...
    eyebrow: "Learning",
    description:
      "Public CC-licensed database of translated essays, research parameters, and code logs.",
    layout: "listing",
    parentLabel: "Learning",
    parentHref: "/learning",
    items: [
      {
        ...
        description:
          "Raw soil telemetry measurements collected during the September physical retreat.",
        tag: "CSV Dataset",
      },
      {
        title: "Symposium Translation Manuscripts",
        description:
          "Translations of critical posthuman philosophy essays into four regional languages.",
        tag: "PDF Archive",
      },
    ],
    relatedLinks: [
  ...
  "learning/faq": {
    ...
    eyebrow: "Learning",
    description:
      "Answers to common conceptual and structural questions about the Posthuman Lab Network.",
    layout: "listing",
    parentLabel: "Learning",
    parentHref: "/learning",
    items: [
      {
        ...
        description:
          "It refers to decentering the human observer and understanding agency as distributed across nature, technology, and ecosystems, rather than than focusing on sci-fi transhumanism.",
        tag: "Conceptual FAQ",
      },
      {
  ...
  "events/past": {
    ...
    eyebrow: "Events",
    description:
      "Documented history of our physical meetups, online panels, and woodland workshops.",
    layout: "listing",
    parentLabel: "Events",
    parentHref: "/events",
    items: [
      {
        ...
        description:
          "A week-long presentation of lichen generative visual canvas mappings held in Berlin.",
    ...
    items: [
      {
        ...
        description:
          "Step-by-step tutorial on assembling micro-controllers and biological interfaces.",
    ...
    items: [
      {
        ...
        description:
          "Masterclass presentation by Dr. Elena Rostova exploring Barad's physical theories.",
        tag: "Guest Seminar",
      },
      {
        title: "Decentered Web Networks",
        description:
          "Exploring low-power, distributed protocols and lightweight interface designs.",
        tag: "Guest Seminar",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "A conversation on building physical interfaces between plants and modular synthesizers.",
        tag: "Podcast Audio",
      },
      {
        title: "Episode 11: Decentering the Human Web",
        description:
          "A debate on low-power servers, static generation, and the carbon cost of modern AI.",
        tag: "Podcast Audio",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "Discussing spatial visual topologies, lichen models, and browser-canvas rendering.",
        tag: "Text Transcript",
      },
      {
        title: "Decolonial Software Networks: Interview with Anya Chen",
        description:
          "Discussing language constraints in algorithmic models and collaborative coding patterns.",
        tag: "Text Transcript",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "A 10-minute visual essay documenting our 3-day retreat writing code and clay sculpting.",
        tag: "Video Documentary",
      },
      {
        title: "Community Sensor Deployment Logs",
        description:
          "Video documentation of local cells setting up turbidity sensors in urban streams.",
        tag: "Video Documentary",
      },
    ],
    relatedLinks: [
  ...
  "membership/benefits": {
    ...
    eyebrow: "Membership",
    description:
      "What it means to join our distributed network. Values, open resources, and grants.",
    layout: "editorial",
    ...
    editorialSections: [
      {
        ...
        content:
          "Members receive full access to our study guides, reading list outlines, print-ready PDFs, and code repositories. We operate on a CC-BY-NC license, ensuring you can use and translate our guides for local cell workshops.",
      },
      {
    ...
    editorialSections: [
      {
        ...
        content:
          "Start by navigating the Foundational Concepts glossary and reading maps. Download study materials and attend monthly virtual Global Conversations.",
      },
      {
    ...
    items: [
      {
        title: "Agential Realism and Nonhuman Subjectivities",
        description:
          "Elena Rostova analyzes Karen Barad's physical theories and Donna Haraway's planetary co-dependence.",
        tag: "Critical Essay",
        date: "July 2026",
      },
      {
        ...
        description:
          "Anya Chen audits semantic bias and decolonial programming guidelines inside modern LLMs.",
        tag: "Research Paper",
        date: "June 2026",
      },
    ],
  ...
  "publications/essays": {
    ...
    eyebrow: "Publications",
    description:
      "Shorter, artistic reflections and conceptual writings on technology, nature, and art.",
    layout: "listing",
    parentLabel: "Publications",
    parentHref: "/publications",
    items: [
      {
        ...
        description:
          "Marcus Vance maps slow botanical patterns into generative browser layout configurations.",
        tag: "Creative Essay",
        date: "June 2026",
      },
      {
        ...
        description:
          "Reflections on field recording, woodland voltages, and decentering human auditory patterns.",
        tag: "Acoustic Essay",
        date: "May 2026",
      },
    ],
    ...
    items: [
      {
        ...
        description:
          "Soil salinity and turbidity datasets collected by community water monitoring cells.",
        tag: "Data Report",
        date: "May 2026",
      },
      {
        ...
        description:
          "Technical parameters of our peer-to-peer bibliography synchronization protocols.",
        tag: "Technical Draft",
        date: "April 2026",
      },
    ],
    ...
    items: [
      {
        ...
        description:
          "A short documentary recording modular soundscapes generated by soil bio-sensors.",
        tag: "Media Log",
        date: "June 2026",
      },
      {
    ...
    items: [
      {
        ...
        description:
          "A three-day off-grid gathering to cook together, program, and audit technology systems.",
        tag: "Retreat Schedule",
      },
      {
        title: "Local Cell Reading Circle meetups",
        description:
          "Informal, horizontal meetups organized locally by distributed network members.",
        tag: "Local Meetup",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "Listening exercises focused on documenting non-human audio patterns in urban parks.",
        tag: "Somatic Practice",
      },
      {
        title: "Clay Sculpting and Technology Audits",
        description:
          "Shaping raw clay while discussing software structures, linking organic and digital matter.",
        tag: "Art Practice",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "Deploying local monitoring cells to track turbidity changes in public urban waterways.",
        tag: "Grassroots Project",
      },
      {
        title: "Decentralized Seed Library Archive",
        description:
          "Collaborative plant cataloging and seed exchange indexes managed by local members.",
    ...
    items: [
      {
        ...
        description:
          "Integrating ecological sensors in Germany and India into a single visual ledger.",
        tag: "Cross-Cell Project",
      },
      {
        title: "Translation Circle Alliance",
        description:
          "Collaborative translation of primary philosophy texts led by East Asian and Latin cells.",
        tag: "Cross-Cell Project",
      },
    ],
    relatedLinks: [
    ...
    items: [
      {
        ...
        description:
          "Join active voice channels to critique essays, share reference files, and code guides.",
        tag: "Discord Circle",
      },
      {
        title: "Hardware Hack Q&A Board",
        description:
          "Online forum tracking soil sensor voltage offsets and sensor calibration tips.",
        tag: "Forum Board",
      },
    ],
    relatedLinks: [
    ...
    editorialSections: [
      {
        ...
        content:
          "If you speak multiple regional languages, you can contribute by translating our public study manuals, glossary files, and guides. Submit these using our Publications workspace.",
      },
      {
        heading: "Sensor Node donations",
        content:
          "Support the network by purchasing and donating pre-assembled ESP32 water/soil sensor kits to emerging cell organizers who lack access to parts.",
      },
    ],
    relatedLinks: [
      { label: "Why Support?", href: "/support/why-support" },
