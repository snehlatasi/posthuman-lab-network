...
export const conversationsList: ConversationTheme[] = [
  ...
  },
  {
    ...
    description:
      "Decentering anthropocentric views. Exploring symbiotic networks and species interdependency.",
...
export const learningPathwaysList: LearningPathway[] = [
  {
    ...
    description:
      "Begin with our open dictionary defining posthuman subjectivity, agential realism, and sympoiesis.",
  ...
  },
  {
    ...
    description:
      "Navigate curated step-by-step pathways and bibliographies to structure self-directed academic studies.",
  ...
  },
  {
    ...
    description:
      "Watch past video seminars and panel discussions led by international researchers and artists.",
