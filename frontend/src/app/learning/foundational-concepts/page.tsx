...
const conceptsList: ConceptItem[] = [
  {
    ...
    tag: "Karen Barad",
    definition:
      "An epistemological and ontological framework that views the universe as consisting of dynamic, entangled relations rather than separate entities.",
  },
  {
    term: "Sympoiesis",
    tag: "Donna Haraway",
    definition:
      "Literally meaning 'making-with'. Fosters the idea that no organism or system generates or survives entirely on its own.",
  },
  {
    term: "Decentering",
    tag: "Critical Theory",
    definition:
      "Repositioning the human observer away from the master center of universe calculations, recognizing biological and artificial partners.",
  },
];
          ...
          <ContentCard className="border border-bone-200/5 bg-carbon-900/10">
            <div className="space-y-6 h-full flex flex-col justify-between">
              <div className="space-y-2">
                ...
                <h3 className="font-serif text-lg font-bold text-bone-100">{concept.term}</h3>
