      ...
      <div className="space-y-8 font-sans">
        <section className="space-y-4">
          ...
          <p className="text-sm md:text-base text-bone-200/70 leading-relaxed">
            This module provides a critical introduction to posthuman thought. Students will examine
            key texts that critique classical humanism, tracing the roots of human exceptionalism
            and exploring how modern technology, environmental changes, and scientific revelations
            reshape our understanding of what it means to be human.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2 text-xs md:text-sm text-bone-200/60 leading-relaxed">
            <li>
              *The Posthuman* by Rosi Braidotti (2013) — Mapping posthuman subjectivity and ethics.
            </li>
            <li>
              *Staying with the Trouble* by Donna Haraway (2016) — Sympoiesis and co-existence on a
              damaged planet.
            </li>
            <li>
              *Meeting the Universe Halfway* by Karen Barad (2007) — Agential realism and quantum
              entanglement.
            </li>
          </ul>
        </section>
