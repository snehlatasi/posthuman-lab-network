...
export const UpcomingEventsSection: React.FC = () => {
  return (
    <section id="events" className="py-24 md:py-32 border-t border-carbon-950/8 dark:border-bone-50/12 bg-gradient-to-b from-[var(--section-gradient-from)] to-[var(--section-gradient-to)] relative transition-colors duration-300">
