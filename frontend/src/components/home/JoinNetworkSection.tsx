...
export const JoinNetworkSection: React.FC = () => {
  return (
    <section className="py-28 md:py-36 border-t border-bone-200/5 bg-carbon-900/5 relative overflow-hidden">
      ...
      <Container className="text-center space-y-8 relative z-10 max-w-3xl">
        ...
        <Reveal delay={0.35} yOffset={28}>
          <p className="font-sans text-sm md:text-base text-bone-200/60 leading-relaxed max-w-xl mx-auto">
        ...
        <Reveal delay={0.5} className="pt-4">
          <Link
            ...
            className="group inline-flex items-center justify-center px-8 py-4 text-xs font-sans tracking-widest uppercase font-bold text-carbon-950 bg-bone-100 hover:bg-moss-500 hover:text-bone-50 transition-colors rounded-full focus:outline-none"
          >
